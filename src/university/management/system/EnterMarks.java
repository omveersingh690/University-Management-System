...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        ...
        // Positioning fields
        JTextField[] subjectFields = {tfsub1, tfsub2, tfsub3, tfsub4, tfsub5};
        JTextField[] marksFields = {tfmarks1, tfmarks2, tfmarks3, tfmarks4, tfmarks5};

        for (int i = 0; i < 5; i++) {
            subjectFields[i].setBounds(50, 200 + (i * 30), 200, 20);
            add(subjectFields[i]);

            marksFields[i].setBounds(250, 200 + (i * 30), 200, 20);
            add(marksFields[i]);
        }
        ...
        if (ae.getSource() == submit) {
            try {
                ...
                String query1 = "INSERT INTO subject (rollno, semester, subject1, subject2, subject3, subject4, subject5) VALUES ('" +
                        crollno.getSelectedItem() + "', '" + cbsemester.getSelectedItem() + "', '" + tfsub1.getText() + "', '" +
                        tfsub2.getText() + "', '" + tfsub3.getText() + "', '" + tfsub4.getText() + "', '" + tfsub5.getText() + "')";

                String query2 = "INSERT INTO marks (rollno, semester, marks1, marks2, marks3, marks4, marks5) VALUES ('" +
                        crollno.getSelectedItem() + "', '" + cbsemester.getSelectedItem() + "', '" + tfmarks1.getText() + "', '" +
                        tfmarks2.getText() + "', '" + tfmarks3.getText() + "', '" + tfmarks4.getText() + "', '" + tfmarks5.getText() + "')";
